"use strict";var h=Object.defineProperty;var u=(s,e,t)=>e in s?h(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var r=(s,e,t)=>u(s,typeof e!="symbol"?e+"":e,t);Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});class c{constructor(e){r(this,"config");r(this,"retentionDialog",null);r(this,"retentionIframe",null);r(this,"subscriptionIframe",null);r(this,"styleSheet",null);r(this,"windowListener",null);this.config=e,!(typeof window>"u")&&this.initialize()}static getInstance(e){if(typeof window>"u")return new c(e);if(window.RENUMERATE_INSTANCE){const n=window.RENUMERATE_INSTANCE;return n.updateConfig(e),n}const t=new c(e);return window.RENUMERATE_INSTANCE=t,t}updateConfig(e){this.config=e}mountCancelButton(e,t,n=""){if(!this.isSessionType(t,"retention"))throw new Error(`Invalid sessionId: ${t}. Expected a retention session ID.`);const i=document.createElement("button");i.textContent="Cancel Subscription",i.addEventListener("click",()=>{this.showRetentionView(t)}),n?i.className=n:i.className="renumerate-cancel-btn";const o=document.getElementById(e);if(!o)throw new Error(`Element with id ${e} not found`);o.appendChild(i)}showRetentionView(e){if(!this.isSessionType(e,"retention")&&!this.isSessionType(e,"subscription"))throw new Error(`Invalid sessionId: ${e}. Expected a retention or subscription session ID.`);this.retentionDialog=document.createElement("dialog"),this.retentionDialog.className="renumerate-dialog";const t=document.createElement("button");t.className="renumerate-dialog-close",t.innerHTML="&times;",t.setAttribute("aria-label","Close"),this.retentionDialog.appendChild(t),t.addEventListener("click",()=>{var i;(i=this.retentionDialog)==null||i.close()});const n=document.createElement("div");return n.className="renumerate-dialog-content",this.retentionIframe=document.createElement("iframe"),this.retentionIframe.src=this.buildUrl({target:"retention",sessionId:e}),n.appendChild(this.retentionIframe),this.retentionDialog.appendChild(n),n.prepend(t),document.body.appendChild(this.retentionDialog),this.retentionDialog.showModal(),t.blur(),this.retentionDialog.addEventListener("close",()=>{var i;(i=this.retentionDialog)==null||i.remove()}),this.retentionDialog}mountSubscriptionHub(e,t,n="",i=""){if(!this.isSessionType(t,"subscription"))throw new Error(`Invalid sessionId: ${t}. Expected a subscription session ID.`);const o=document.createElement("div");o.className=n||"renumerate-subscription-hub";const a=document.getElementById(e);if(!a)throw new Error(`Element with id ${e} not found`);return a.appendChild(o),this.subscriptionIframe=document.createElement("iframe"),this.subscriptionIframe.src=this.getSubscriptionHubUrl(t),this.subscriptionIframe.className=i||"renumerate-subscription-hub-iframe",this.subscriptionIframe.title="SubscriptionHub",o.appendChild(this.subscriptionIframe),o}getSubscriptionHubUrl(e){if(!this.isSessionType(e,"subscription"))throw new Error(`Invalid sessionId: ${e}. Expected a subscription session ID.`);return this.buildUrl({target:"subscription",sessionId:e})}initialize(){this.config.debug&&console.info("Renumerate initialized with config:",this.config),this.injectStylesheet(),this.addListener()}cleanup(){this.config.debug&&console.info("Renumerate cleaned up with config:",this.config),this.retentionDialog&&(this.retentionDialog.remove(),this.retentionDialog=null),this.retentionIframe&&(this.retentionIframe.remove(),this.retentionIframe=null),this.subscriptionIframe&&(this.subscriptionIframe.remove(),this.subscriptionIframe=null),this.styleSheet&&(this.styleSheet.remove(),this.styleSheet=null),this.windowListener&&(window.removeEventListener("message",this.windowListener),this.windowListener=null)}isSessionType(e,t){switch(t){case"retention":return e.startsWith("ret_");case"subscription":return e.startsWith("sub_");default:throw new Error(`Unknown session type: ${t}`)}}getIsLocal(){return typeof window<"u"&&window.RENUMERATE_LOCAL===!0}injectStylesheet(){const e=document.querySelector("style[data-renumerate-dialog-styles]");if(e){this.styleSheet=e;return}this.styleSheet=document.createElement("style"),this.styleSheet.type="text/css",this.styleSheet.setAttribute("data-renumerate-dialog-styles","true"),this.styleSheet.innerHTML=`
    ...
    `,document.head.appendChild(this.styleSheet)}addListener(){this.config.debug&&console.info("Adding message listener for Renumerate"),this.windowListener=e=>{var a,l;if(this.config.debug&&console.info("Received message:",e.data),!(this.getIsLocal()?["http://localhost:3000","http://localhost:4321"]:["https://retention.renumerate.com","https://subs.renumerate.com"]).includes(e.origin)){console.warn("Received message from unauthorized origin:",e.origin);return}const{type:i,data:o}=e.data;switch(i){case"cancel-subscription":{this.showRetentionView(o.sessionId);return}case"resize":{this.retentionIframe&&o.height&&typeof o.height=="number"&&o.height>0&&(this.retentionIframe.style.height=`${o.height}px`);return}case"close-dialog":{this.retentionDialog&&this.retentionDialog.close();return}case"subscription-invalidate":{const d=this.getIsLocal()?"http://localhost:4321":"https://subs.renumerate.com";(l=(a=this.subscriptionIframe)==null?void 0:a.contentWindow)==null||l.postMessage({type:"subscription-invalidate",data:o},d);return}default:console.warn(`Unknown message type: ${i}`)}},window.addEventListener("message",this.windowListener)}buildUrl(e){const t=this.getIsLocal(),n=(i,o)=>`${i}?session_id=${o}`;switch(e.target){case"retention":return n(t?"http://localhost:4321/retention":"https://retention.renumerate.com",e.sessionId);case"subscription":return n(t?"http://localhost:4321/subs":"https://subs.renumerate.com",e.sessionId);case"event":return t?"http://localhost:4321/event/":"https://renumerate.com/event/";default:throw new Error(`Unknown type: ${e}`)}}}exports.Renumerate=c;
