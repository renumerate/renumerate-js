(function(s,n){typeof exports=="object"&&typeof module<"u"?n(exports):typeof define=="function"&&define.amd?define(["exports"],n):(s=typeof globalThis<"u"?globalThis:s||self,n(s.Renumerate={}))})(this,function(s){"use strict";var u=Object.defineProperty;var p=(s,n,l)=>n in s?u(s,n,{enumerable:!0,configurable:!0,writable:!0,value:l}):s[n]=l;var a=(s,n,l)=>p(s,typeof n!="symbol"?n+"":n,l);class n{constructor(e){a(this,"config");a(this,"retentionDialog",null);a(this,"retentionIframe",null);a(this,"subscriptionIframe",null);a(this,"styleSheet",null);a(this,"windowListener",null);this.config=e,!(typeof window>"u")&&this.initialize()}static getInstance(e){if(typeof window>"u")return new n(e);if(window.RENUMERATE_INSTANCE){const o=window.RENUMERATE_INSTANCE;return o.updateConfig(e),o}const t=new n(e);return window.RENUMERATE_INSTANCE=t,t}updateConfig(e){this.config=e}mountCancelButton(e,t,o=""){if(!this.isSessionType(t,"retention"))throw new Error(`Invalid sessionId: ${t}. Expected a retention session ID.`);const i=document.createElement("button");i.textContent="Cancel Subscription",i.addEventListener("click",()=>{this.showRetentionView(t)}),o?i.className=o:i.className="renumerate-cancel-btn";const r=document.getElementById(e);if(!r)throw new Error(`Element with id ${e} not found`);r.appendChild(i)}showRetentionView(e){if(!this.isSessionType(e,"retention")&&!this.isSessionType(e,"subscription"))throw new Error(`Invalid sessionId: ${e}. Expected a retention or subscription session ID.`);this.retentionDialog=document.createElement("dialog"),this.retentionDialog.className="renumerate-dialog";const t=document.createElement("button");t.className="renumerate-dialog-close",t.innerHTML="&times;",t.setAttribute("aria-label","Close"),this.retentionDialog.appendChild(t),t.addEventListener("click",()=>{var i;(i=this.retentionDialog)==null||i.close()});const o=document.createElement("div");return o.className="renumerate-dialog-content",this.retentionIframe=document.createElement("iframe"),this.retentionIframe.src=this.buildUrl({target:"retention",sessionId:e}),o.appendChild(this.retentionIframe),this.retentionDialog.appendChild(o),o.prepend(t),document.body.appendChild(this.retentionDialog),this.retentionDialog.showModal(),t.blur(),this.retentionDialog.addEventListener("close",()=>{var i;(i=this.retentionDialog)==null||i.remove()}),this.retentionDialog}mountSubscriptionHub(e,t,o="",i=""){if(!this.isSessionType(t,"subscription"))throw new Error(`Invalid sessionId: ${t}. Expected a subscription session ID.`);const r=document.createElement("div");r.className=o||"renumerate-subscription-hub";const c=document.getElementById(e);if(!c)throw new Error(`Element with id ${e} not found`);return c.appendChild(r),this.subscriptionIframe=document.createElement("iframe"),this.subscriptionIframe.src=this.getSubscriptionHubUrl(t),this.subscriptionIframe.className=i||"renumerate-subscription-hub-iframe",this.subscriptionIframe.title="SubscriptionHub",r.appendChild(this.subscriptionIframe),r}getSubscriptionHubUrl(e){if(!this.isSessionType(e,"subscription"))throw new Error(`Invalid sessionId: ${e}. Expected a subscription session ID.`);return this.buildUrl({target:"subscription",sessionId:e})}initialize(){this.config.debug&&console.info("Renumerate initialized with config:",this.config),this.injectStylesheet(),this.addListener()}cleanup(){this.config.debug&&console.info("Renumerate cleaned up with config:",this.config),this.retentionDialog&&(this.retentionDialog.remove(),this.retentionDialog=null),this.retentionIframe&&(this.retentionIframe.remove(),this.retentionIframe=null),this.subscriptionIframe&&(this.subscriptionIframe.remove(),this.subscriptionIframe=null),this.styleSheet&&(this.styleSheet.remove(),this.styleSheet=null),this.windowListener&&(window.removeEventListener("message",this.windowListener),this.windowListener=null)}isSessionType(e,t){switch(t){case"retention":return e.startsWith("ret_");case"subscription":return e.startsWith("sub_");default:throw new Error(`Unknown session type: ${t}`)}}getIsLocal(){return typeof window<"u"&&window.RENUMERATE_LOCAL===!0}injectStylesheet(){const e=document.querySelector("style[data-renumerate-dialog-styles]");if(e){this.styleSheet=e;return}this.styleSheet=document.createElement("style"),this.styleSheet.type="text/css",this.styleSheet.setAttribute("data-renumerate-dialog-styles","true"),this.styleSheet.innerHTML=`
    ...
    `,document.head.appendChild(this.styleSheet)}addListener(){this.config.debug&&console.info("Adding message listener for Renumerate"),this.windowListener=e=>{var c,d;if(this.config.debug&&console.info("Received message:",e.data),!(this.getIsLocal()?["http://localhost:3000","http://localhost:4321"]:["https://retention.renumerate.com","https://subs.renumerate.com"]).includes(e.origin)){console.warn("Received message from unauthorized origin:",e.origin);return}const{type:i,data:r}=e.data;switch(i){case"cancel-subscription":{this.showRetentionView(r.sessionId);return}case"resize":{this.retentionIframe&&r.height&&typeof r.height=="number"&&r.height>0&&(this.retentionIframe.style.height=`${r.height}px`);return}case"close-dialog":{this.retentionDialog&&this.retentionDialog.close();return}case"subscription-invalidate":{const h=this.getIsLocal()?"http://localhost:4321":"https://subs.renumerate.com";(d=(c=this.subscriptionIframe)==null?void 0:c.contentWindow)==null||d.postMessage({type:"subscription-invalidate",data:r},h);return}default:console.warn(`Unknown message type: ${i}`)}},window.addEventListener("message",this.windowListener)}buildUrl(e){const t=this.getIsLocal(),o=(i,r)=>`${i}?session_id=${r}`;switch(e.target){case"retention":return o(t?"http://localhost:4321/retention":"https://retention.renumerate.com",e.sessionId);case"subscription":return o(t?"http://localhost:4321/subs":"https://subs.renumerate.com",e.sessionId);case"event":return t?"http://localhost:4321/event/":"https://renumerate.com/event/";default:throw new Error(`Unknown type: ${e}`)}}}s.Renumerate=n,Object.defineProperty(s,Symbol.toStringTag,{value:"Module"})});
